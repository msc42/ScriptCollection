...
def convert_encoding(encoded_string):
    print(codecs.encode(codecs.decode(encoded_string.encode('utf-8'), 'hex'), 'base64').decode().rstrip())


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='hex to base64 converter')
